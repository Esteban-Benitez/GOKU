...
# $VENV_PY -u di_baseline_pendulum.py 2>&1 | tee "$LOG_DIR/di_baseline_pendulum.log"
# $VENV_PY -u di_baseline_double_pendulum.py 2>&1 | tee "$LOG_DIR/di_baseline_double_pendulum.log"
$VENV_PY -u di_baseline_csv.py 2>&1 | tee "$LOG_DIR/di_baseline_cvs.log"
