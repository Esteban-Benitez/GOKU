...
goku_ckpt = load_checkpoint("checkpoints_adamw/cvs/goku_model.pkl", device=device)
latent_ode_ckpt = load_checkpoint("checkpoints_adamw/cvs/latent_ode_model.pkl", device=device)
lstm_ckpt = load_checkpoint("checkpoints_adamw/cvs/lstm_model.pkl", device=device)
