...
goku_ckpt = load_checkpoint("checkpoints_adamw/pendulum/goku_model.pkl", device=device)
latent_ode_ckpt = load_checkpoint("checkpoints_adamw/pendulum/latent_ode_model.pkl", device=device)
lstm_ckpt = load_checkpoint("checkpoints_adamw/pendulum/lstm_model.pkl", device=device)
